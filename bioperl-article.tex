...
% $Id: bioperl-article.tex,v 1.27 2002-04-16 20:32:11 jason Exp $
...
however the direction and focus of the project has continue to expand.
...
principals of good design and good documentation have made it easier
...
sourcing principals for the softare.  BioWidgets, an early attempt to
create a toolkit was ultimate unsuccesful because the particpants did
not commit to open source policies from the software.  Software was
eventually withdrawn from the project because of intellectual property
disputes \cite{goodman}.  The NCBI tookit \cite{ncbitoolkit}, a
powerful and highly functional C-language based toolkit, but does not
have the widespread usage that it deserves because of acknowledged
deficiencies in it documentation and closed development process.
Bioperl does not suffer from these weaknesses because it cannot be
withdrawn from the public domain and it cannot become a commericial
entity which requires licensing fees.
...
with features), RichSeq (sequence with features and additional
annotation), LargePrimarySeq (large sequence not held in memory),
...
such as a set exons), and so-called fuzzy location ( start,end or span
