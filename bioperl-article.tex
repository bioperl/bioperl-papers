...
% $Id: bioperl-article.tex,v 1.34 2002-07-25 18:34:53 jason Exp $
...
bridge.  Bioperl provides access to legacy data stores such as Genbank
and Swissprot via a flexible series of sequence input/output modules,
and to the emerging common sequence data storage format of Open
